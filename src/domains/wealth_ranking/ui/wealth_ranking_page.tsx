...
import { WealthRankingResult } from "./wealth_ranking_result";
                ...
                {flow.participants.map((participant, index) => (
                  ...
                  >
                    ...
                    <button
                      ...
                      onClick={() =>
                        flow.removeParticipant(participant.profileId)
                      }
                      type="button"
                    >
            ...
            <section className="mt-5" aria-busy={flow.isGenerating}>
              ...
              {flow.isGenerating && (
                <p
                  ...
                  role="status"
                >
                  참여자들의 사주를 비교하고 있어요. 최대 1분 정도 걸릴 수
                  있어요.
                </p>
              )}
              {flow.readingError && (
              ...
              <p className="mt-3 text-center text-[11px] leading-5 text-muted-foreground">
                풀이 결과는 현재 화면에서 확인할 수 있어요.
                <br />
                새로고침하면 참여자를 다시 선택해야 해요.
              </p>
            </section>
          )}
        </>
