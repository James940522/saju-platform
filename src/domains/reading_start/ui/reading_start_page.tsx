    ...
    <main className="min-h-dvh px-4 pb-[calc(24px+env(safe-area-inset-bottom))] pt-[calc(16px+env(safe-area-inset-top))]">
      <header className="flex items-center gap-3">
        ...
        <div className="min-w-0">
          <p className="text-[11px] font-semibold text-brand-gold-muted">풀이 준비</p>
      ...
      <aside className="mt-4 rounded-2xl border border-border bg-surface px-4 py-3 text-[11px] leading-5 text-muted-foreground">
